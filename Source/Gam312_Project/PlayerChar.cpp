...
APlayerChar::APlayerChar()
{
	...
	//Setup Player characters camera component
	PlayerCamComp = CreateDefaultSubobject<UCameraComponent>(TEXT("First Person Cam"));

	//Attaches the camera to character mesh & head
...
//The following definitions define the functionality of our input actions. 
...
void APlayerChar::SpawnBuilding(int buildingID, bool& isSuccess)
{
	if (!isBuilding)
	{
		if(BuildingArray[buildingID] >= 1)
		{
			...
			spawnedPart = GetWorld()->SpawnActor<ABuildingPart>(BuildingPartClass, EndLocation, FRotator::ZeroRotator, SpawnParams);
